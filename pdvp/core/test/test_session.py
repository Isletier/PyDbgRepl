...
Run from the repo root with the venv active:
    ...
    python -m pdvp.core.test.test_session
"""
import gc
import threading

from pdvp.core import cursor as cursor_module
from pdvp.core import events as E
from pdvp.core import model
from pdvp.core.dap import ConnectionClosed
from pdvp.core.model import Error
from pdvp.core.session import ControlRights, Session
